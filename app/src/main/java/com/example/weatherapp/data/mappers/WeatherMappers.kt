...
import com.example.weatherapp.data.remote.WeatherApiData
...
fun WeatherApiData.toWeatherDataMap(): Map<Int, List<WeatherData>> {
...
fun Weather.toWeatherInfo(): WeatherInfo {
    val weatherDataMap = weatherApiData.toWeatherDataMap()
